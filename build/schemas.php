	...
	public static function getSchemas() : array{
		return [
			...
			58 => [
				...
				'fields' => [
					0 => [
						'name' => 'chunkPosition.x',
						'type' => 'varint',
					],
					1 => [
						'name' => 'chunkPosition.z',
						'type' => 'varint',
					],
					2 => [
						'name' => 'dimensionId',
				...
				'fields' => [
					...
					5 => [
						...
						'entry' => [
							...
							[
								'name' => 'chainedSubCommandDataIndexes',
								'type' => 'array',
								'countType' => 'uvarint',
								'entry' => [
									[
							...
							[
								...
								'entry' => [
									[
										'name' => 'value',
										'type' => 'command_overload_raw_data',
									],
								],
							],
						],
				...
				'fields' => [
					...
					1 => [
						...
						'entry' => [
							...
							[
								'name' => 'syncedUpdateActorUniqueId',
								'type' => 'uvarlong',
							],
							[
								'name' => 'syncedUpdateType',
								'type' => 'uvarint',
							],
						],
					],
			...
			174 => [
				...
				'fields' => [
					...
					1 => [
						'name' => 'baseSubChunkPosition.x',
						'type' => 'varint',
					],
					2 => [
						'name' => 'baseSubChunkPosition.y',
						'type' => 'varint',
					],
					3 => [
						'name' => 'baseSubChunkPosition.z',
						'type' => 'varint',
					],
				],
			],
				...
				'fields' => [
					...
					1 => [
						...
						'entry' => [
							...
							[
								'name' => 'exclusionList',
								'type' => 'camera_aim_assist_preset_exclusion_definition',
							],
							[
