...
final class RuntimePacketRegistry{

	/** @var RuntimePacketHandler[] */
	private array $handlers = [];

	public function register(int $packetId, RuntimePacketHandler $handler) : void{
		$this->handlers[$packetId] = $handler;
	}

	public function get(int $packetId) : ?RuntimePacketHandler{
